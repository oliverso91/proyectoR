...
# Ejemplo de aplicar group_by, summarise y count para obtener estadísticas por categoría (ej. por tipo de membresía)
...
grafico_barras <- ggplot(monthly_member_totals_summary, aes(x = member_id, y = Sum_total_amount)) +
